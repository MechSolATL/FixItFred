...
namespace MVP_Core.Migrations
{
    ...
    [Migration("20250728223337_ToolTrackingSchema_Init")]
    partial class ToolTrackingSchema_Init
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MVP_Core.Data.Models.ComplianceAlertLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MVP_Core.Data.Models.ComplianceOverrideLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MVP_Core.Data.Models.MilestoneAuditLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MVP_Core.Data.Models.NovaIntel.NovaDecisionMemory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MVP_Core.Data.Models.TechMilestone", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MVP_Core.Data.Models.TechnicianAlertLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MVP_Core.Data.Models.Tenant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MVP_Core.Data.Models.ToolInventory", b =>
                {
            ...
            modelBuilder.Entity("MVP_Core.Data.Models.ToolTransferLog", b =>
                {
            ...
            modelBuilder.Entity("MVP_Core.Data.Models.UserOnboardingStatus", b =>
                {
            ...
            modelBuilder.Entity("MVP_Core.Data.Models.BillingInvoiceRecord", b =>
                {
                    b.HasOne("MVP_Core.Data.Models.Customer", "Customer")
                        .WithMany()
                    ...
                    b.HasOne("MVP_Core.Data.Models.Tenant", "Tenant")
                        .WithMany()
            ...
            modelBuilder.Entity("MVP_Core.Data.Models.ToolInventory", b =>
                {
                    b.HasOne("MVP_Core.Data.Models.Technician", "AssignedTechnician")
                        .WithMany()
            ...
            modelBuilder.Entity("MVP_Core.Data.Models.ToolTransferLog", b =>
                {
                    b.HasOne("MVP_Core.Data.Models.Technician", "FromTechnician")
                        .WithMany()
                        .HasForeignKey("FromTechId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MVP_Core.Data.Models.Technician", "ToTechnician")
                        .WithMany()
                        .HasForeignKey("ToTechId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MVP_Core.Data.Models.ToolInventory", "Tool")
                        .WithMany()
