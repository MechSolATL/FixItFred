// =========================
// File: Pages/Services/WaterFiltration.cshtml.cs
// =========================
...
namespace MVP_Core.Pages.Services
{
    public class WaterFiltrationModel : PageModel
    {
        ...
        public WaterFiltrationModel(ApplicationDbContext dbContext)
        {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            var session = HttpContext.Session.GetObject<ServiceRequestSession>(SessionKey)
                          ?? new ServiceRequestSession { ServiceType = "WaterFiltration" };
            ...
            CurrentQuestion = await _dbContext.Questions
                .Include(q => q.Options)
                .Where(q => q.ServiceType == "WaterFiltration")
        ...
        public async Task<IActionResult> OnPostNextAsync()
        {
            ...
            if (!ModelState.IsValid || string.IsNullOrWhiteSpace(UserAnswer) || UserAnswer.Length > 500)
            {
        ...
        private bool IsSessionExpired()
        {
            ...
            return !DateTime.TryParse(sessionStartString, out var sessionStart) ||
